<template>
    <div class="flex">
        ...
        <div class="container mx-auto min-h-screen mt-12">
            ...
            <!--                    </div>-->
            <!--                </div>-->
            <!--                &lt;!&ndash;                <div class="mt-5 md:mt-0 md:col-span-2 lg:col-span-1">&ndash;&gt;-->
            <!--                &lt;!&ndash;                    <div class="shadow overflow-hidden sm:rounded-md">&ndash;&gt;-->
            <!--                &lt;!&ndash;                        <div class="px-4 py-5 bg-white sm:p-6">&ndash;&gt;-->
            <!--                &lt;!&ndash;                            <div class="grid grid-cols-1 gap-6">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                <div class="col-span-6 sm:col-span-3">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    <label for="first-name" class="block text-sm font-medium text-gray-700">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                        Старый пароль&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    </label>&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    <input type="password" v-model="authUser.password" name="first-name"&ndash;&gt;-->
            <!--                &lt;!&ndash;                                           autocomplete="given-name"&ndash;&gt;-->
            <!--                &lt;!&ndash;                                           class="placeholder-shown:font-normal font-black mt-1 custom-input block w-full shadow-sm">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                </div>&ndash;&gt;-->

            <!--                &lt;!&ndash;                                <div class="col-span-6 sm:col-span-3">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    <label for="last-name" class="block text-sm font-medium text-gray-700">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                        Новый пароль&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    </label>&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    <input type="password" v-model="authUser.newpassword" name="last-name"&ndash;&gt;-->
            <!--                &lt;!&ndash;                                           autocomplete="family-name"&ndash;&gt;-->
            <!--                &lt;!&ndash;                                           class="placeholder-shown:font-normal font-black mt-1 custom-input block w-full shadow-sm">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                </div>&ndash;&gt;-->

            <!--                &lt;!&ndash;                                <div class="col-span-6 sm:col-span-3">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    <label for="last-name" class=" block text-sm font-medium text-gray-700">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                        Повторите новый пароль&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    </label>&ndash;&gt;-->
            <!--                &lt;!&ndash;                                    <input type="password" v-model="authUser.newpassword_confirmation"&ndash;&gt;-->
            <!--                &lt;!&ndash;                                           name="last-name" autocomplete="family-name"&ndash;&gt;-->
            <!--                &lt;!&ndash;                                           class="placeholder-shown:font-normal font-black mt-1 custom-input block w-full shadow-sm">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                </div>&ndash;&gt;-->

            <!--                &lt;!&ndash;                            </div>&ndash;&gt;-->
            <!--                &lt;!&ndash;                        </div>&ndash;&gt;-->
            <!--                &lt;!&ndash;                        <div class="px-4 py-3 bg-gray-50 text-right sm:px-6">&ndash;&gt;-->
            <!--                &lt;!&ndash;                            <button&ndash;&gt;-->
            <!--                &lt;!&ndash;                                class="inline-flex btn-primary justify-center py-2 px-4 shadow-sm text-sm font-medium">&ndash;&gt;-->
            <!--                &lt;!&ndash;                                Обновить&ndash;&gt;-->
            <!--                &lt;!&ndash;                            </button>&ndash;&gt;-->
            <!--                &lt;!&ndash;                        </div>&ndash;&gt;-->
            <!--                &lt;!&ndash;                    </div>&ndash;&gt;-->
            <!--                &lt;!&ndash;                </div>&ndash;&gt;-->
